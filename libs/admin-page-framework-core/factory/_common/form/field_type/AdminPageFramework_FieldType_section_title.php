...
class AdminPageFramework_FieldType_section_title extends AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".dgenny-section-tab .dgenny-field-section_title {padding: 0.5em;} .dgenny-section-tab .dgenny-field-section_title .dgenny-input-label-string { vertical-align: middle; margin-left: 0.2em;}.dgenny-section-tab .dgenny-fields {display: inline-block;} .dgenny-field.dgenny-field-section_title {float: none;} .dgenny-field.dgenny-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
