...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".dgenny-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.dgenny-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.dgenny-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.dgenny-field .taxonomy-checklist ul ul {margin-left: 1em;}.dgenny-field .taxonomy-checklist-label {white-space: nowrap; }.dgenny-field .tab-box-container.categorydiv {max-height: none;}.dgenny-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.dgenny-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.dgenny-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.dgenny-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.dgenny-field .tab-box-tabs li a { color: #333; text-decoration: none; }.dgenny-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.dgenny-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.dgenny-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.dgenny-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.dgenny-field .tab-box-content:target, .dgenny-field .tab-box-content:target, .dgenny-field .tab-box-content:target { display: block; }.dgenny-field .tab-box-content .select_all_button_container, .dgenny-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.dgenny-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
