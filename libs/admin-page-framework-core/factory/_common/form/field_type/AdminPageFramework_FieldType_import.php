...
jQuery( document ).ready( function() {
    jQuery( '.dgenny-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.dgenny-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".dgenny-field-import input {margin-right: 0.5em;}.dgenny-field-import,.dgenny-field-import .dgenny-input-label-container {width: 100%;}.dgenny-field-import label,.form-table td fieldset.dgenny-fieldset .dgenny-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
