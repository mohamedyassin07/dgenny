...
jQuery( document ).ready( function(){
    ...
    jQuery().registerAdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.dgenny-field' );
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.dgenny-field' ) 
                        : _oNewField;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.dgenny-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".dgenny-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .dgenny-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .dgenny-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.dgenny-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.dgenny-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.dgenny-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.dgenny-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.dgenny-field .image_preview {max-width: 600px;}}.dgenny-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.dgenny-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='dgenny-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='dgenny-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
            ...
            return <<<JAVASCRIPTS
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.dgenny-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
JAVASCRIPTS;
        ...
        protected function getStyles() {
            return ".dgenny-field-media input {margin-right: 0.5em;vertical-align: middle;}@media screen and (max-width: 782px) {.dgenny-field-media input {margin: 0.5em 0.5em 0.5em 0;}} .select_media.button.button-small,.remove_media.button.button-small{ vertical-align: middle;}.remove_media.button.button-small {margin-left: 0.2em;}";
        }
        protected function _getPreviewContainer($aField, $sImageURL, $aPreviewAtrributes) {
            return "";
        }
...
JAVASCRIPTS;
            return "<script type='text/javascript' class='dgenny-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
        }
