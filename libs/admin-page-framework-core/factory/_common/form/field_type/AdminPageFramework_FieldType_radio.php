...
class AdminPageFramework_FieldType_radio extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".dgenny-field input[type='radio'] {margin-right: 0.5em;} .dgenny-field-radio .dgenny-input-label-container {padding-right: 1em;} .dgenny-field-radio .dgenny-input-container {display: inline;} .dgenny-field-radio .dgenny-input-label-string{display: inline; }";
    }
    ...
    jQuery().registerAdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {            
            oCloned.find( 'input[type=radio]' )
                ...
                jQuery( this ).closest( '.dgenny-field' ).find( 'input[type=radio]' )
                    .prop( 'checked', false )
                    .attr( 'checked', false ); 
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).on( 'change', function( e ) {
        ...
        // Uncheck the other radio buttons
        jQuery( this ).closest( '.dgenny-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' )
            .prop( 'checked', false )
            .attr( 'checked', false );
