...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.dgenny-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.dgenny-checkbox-label {margin-top: 0.1em;}.dgenny-field input[type='checkbox' ] {margin-right: 0.5em;} .dgenny-field-checkbox .dgenny-input-label-container {padding-right: 1em;}.dgenny-field-checkbox .dgenny-input-label-string{display: inline; }";
    }
    ...
    class AdminPageFramework_FieldType_posttype extends AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".dgenny-field input[type='checkbox'] {margin-right: 0.5em;} .dgenny-field-posttype .dgenny-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
