...
abstract class AdminPageFramework_FieldType_Base extends AdminPageFramework_Form_Utility {
    ...
    class AdminPageFramework_FieldType_color extends AdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.dgenny-field-color .wp-picker-container {vertical-align: middle;}.dgenny-field-color .ui-widget-content {border: none;background: none;color: transparent;}.dgenny-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.dgenny-field-color .dgenny-repeatable-field-buttons {margin-top: 0;}.dgenny-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
...
registerAdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'dgenny_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'dgenny_field_type_color_cleared',
...
JAVASCRIPTS;
        ...
        protected function getField($aField) {
            ...
            return $aField['before_label'] . "<div class='dgenny-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'dgenny-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
        }
