...
class AdminPageFramework_FieldType_submit extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".dgenny-field input[type='submit'] {margin-bottom: 0.5em;}.dgenny-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.dgenny-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.dgenny-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.dgenny-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.dgenny-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.dgenny-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
...
JAVASCRIPTS;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'dgenny-input-label-container' . ' dgenny-input-button-container' . ' dgenny-input-container',);
    }
