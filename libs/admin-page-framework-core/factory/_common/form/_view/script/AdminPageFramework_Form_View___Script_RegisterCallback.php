...
(function ( $ ) {
     ...
     */  
    $( document ).on( 'dgenny_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     * 
     * Unlike the `dgenny_added_repeatable_field` event, this does not call the callback function
     ...
     */
    $( document ).on( 'dgenny_repeated_field', function( oEvent, iCallType, oModelContainer ){
     ...
     * @since       3.8.0
     */
    $( document ).on( 'dgenny_stopped_sorting_sections', function( oEvent ){  
     ...
     */
    /* $( document ).on( 'dgenny_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
     ...
     * @since    3.2.0 
     */
    $( document ).on( 'dgenny_saved_widget', function( event, oWidget ){
