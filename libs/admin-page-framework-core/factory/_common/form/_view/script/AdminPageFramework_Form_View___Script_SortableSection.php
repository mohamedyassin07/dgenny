...
(function($) {
    $.fn.enableAdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'dgenny-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.dgenny-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.dgenny-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .dgenny-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.dgenny-section-caption'
                    : false,
                ...
                stop: function(e,ui) {
                    ...
                    jQuery( this ).trigger( 
                        'dgenny_stopped_sorting_sections', 
                ...
                // cancel: '.dgenny-section-description, .dgenny-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.on( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .dgenny-section-title:not(.dgenny-collapsible-sections-title,.dgenny-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .dgenny-section-title:not(.dgenny-collapsible-sections-title,.dgenny-collapsible-section-title)' ).not( ':first' ).hide();
...
JAVASCRIPTS;
            return "<script type='text/javascript' class='dgenny-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
    }
