...
class AdminPageFramework_Form_View__Resource__Head extends AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertRequiredInternalScripts() {
        ...
        echo "<script type='text/javascript' class='dgenny-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'dgenny-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".dgenny-form-js-on {visibility: hidden;}.widget .dgenny-form-js-on { visibility: visible; }";
    }
    }
