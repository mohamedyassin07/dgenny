...
class AdminPageFramework_Form_View___Section_Base extends AdminPageFramework_Form_Base {
    ...
    class AdminPageFramework_Form_View___SectionTitle extends AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='dgenny-collapsible-button dgenny-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='dgenny-collapsible-button dgenny-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
    ...
    class AdminPageFramework_Form_View___CollapsibleSectionTitle extends AdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('dgenny-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'dgenny-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'dgenny-collapsible-sections-title', 'dgenny-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'dgenny-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
