...
class AdminPageFramework_Form_View___SectionCaption extends AdminPageFramework_FrameworkUtility {
    ...
    private function _getCaption(array $aSectionset, $iSectionIndex, $aFieldsets, $aFieldErrors, $aFieldTypeDefinitions, $aCallbacks, $oMsg) {
        if (!$aSectionset['description'] && !$aSectionset['title']) {
            return "<caption class='dgenny-section-caption' style='display:none;'></caption>";
        }
    ...
    private function _getSectionError($aSectionset, $aFieldErrors) {
        ...
        return $_sSectionError ? "<div class='dgenny-error'><span class='section-error'>* " . $_sSectionError . "</span></div>" : '';
    }
    private function _getCaptionTitle($aSectionset, $iSectionIndex, $aFieldsets, $aFieldTypeDefinitions) {
        ...
        return "<div " . $this->getAttributes(array('class' => 'dgenny-section-title', 'style' => $this->getAOrB($this->_shouldShowCaptionTitle($aSectionset, $iSectionIndex), '', 'display: none;'),)) . ">" . $_oSectionTitle->get() . "</div>";
    }
    private function _getCaptionDescription($aSectionset, $hfSectionCallback) {
        ...
        $_oSectionDescription = new AdminPageFramework_Form_View___Description($aSectionset['description'], 'dgenny-section-description');
        return "<div class='dgenny-section-description'>" . call_user_func_array($hfSectionCallback, array($_oSectionDescription->get(), $aSectionset)) . "</div>";
    }
