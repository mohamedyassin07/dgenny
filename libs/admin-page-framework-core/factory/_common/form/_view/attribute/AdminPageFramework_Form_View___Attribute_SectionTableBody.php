...
class AdminPageFramework_Form_View___Attribute_SectionTableBody extends AdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        ...
        return array('class' => $this->getAOrB($this->aArguments['_is_collapsible'], 'dgenny-collapsible-section-content' . ' ' . 'dgenny-collapsible-content' . ' ' . 'accordion-section-content' . ' ' . 'dgenny-collapsible-content-type-' . $_sCollapsibleType, null),);
    }
    }
