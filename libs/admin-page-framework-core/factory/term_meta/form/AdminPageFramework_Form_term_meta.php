...
class AdminPageFramework_Form_term_meta extends AdminPageFramework_Form_Meta {
    ...
    public function get() {
        ...
        $_sClassSelectors = 'dgenny-form-table-term_meta' . $_sAddNewTerm;
        return '<tr class="dgenny-form-table-outer-row-term_meta">' . '<td colspan=2>' . '<table class="' . $_sClassSelectors . '">' . '<tbody>' . '<tr>' . '<td>' . $_oFormTables->get() . '</td>' . '</tr>' . '</tbody>' . '</table>' . '</td>' . '</tr>';
    }
    }
