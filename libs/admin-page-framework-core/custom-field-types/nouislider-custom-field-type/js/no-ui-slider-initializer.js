(function ($) {
    jQuery( document ).ready( function(){
        ...
        var _initializeNoUISliders = function( nodeThis ) {
            ...
            var _oTargetSlider = jQuery( nodeThis ).closest( '.dgenny-field' )
            ...
            initializeNoUISlider(
                jQuery( nodeThis ).closest( '.dgenny-field' )
                    .children( '.no-ui-sliders' )
                    .first().get( 0 )
            );
        ...
        jQuery( 'input[data-type=no_ui_slider][data-interactive=1]' ).on( 'change', function(){
            ...
            var _oTargetSlider    = jQuery( this ).closest( '.dgenny-field' )
                .children( '.no-ui-sliders' )
                .first();
            ...
            function _setEmptyInputValues( nodeInput, aValues ) {
                ...
                jQuery( nodeInput ).closest( '.dgenny-field' ).children( '.dgenny-input-label-container' )
            ...
            function _getInputValuesSanitized( aValues, nodeInput ) {
                ...
                var _aValues = [];
                var _aRange  = jQuery( nodeInput ).closest( '.dgenny-field' ).children( '.no-ui-sliders' )
                    .first()
                    .data( 'range' );
