...
class PathCustomFieldType extends AdminPageFramework_FieldType_image {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField[ 'before_label' ]
            . "<div class='dgenny-input-label-container dgenny-input-container {$aField[ 'type' ]}-field'>" 
                . "<label for='{$aField[ 'input_id' ]}'>"
                    . $aField[ 'before_input' ]
                    . $this->getAOrB(
                        $aField[ 'label' ] && ! $aField[ 'repeatable' ],
                        "<span " . $this->getLabelContainerAttributes( $aField, 'dgenny-input-label-string' ) . ">" 
                            . $aField[ 'label' ] 
                        . "</span>",                        
                        ''                        
                    )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='dgenny-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='dgenny-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'dgenny-field-type-pack' )
                            )
                        )
                    ."</a>";
