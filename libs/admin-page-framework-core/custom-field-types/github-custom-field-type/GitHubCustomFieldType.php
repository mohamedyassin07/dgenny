...
class GitHubCustomFieldType extends AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='dgenny-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='dgenny-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'dgenny' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'dgenny' );
                case 'star':
                    return __( 'Star', 'dgenny' );
                case 'fork':
                    return __( 'Fork', 'dgenny' );
                case 'issue':
                    return __( 'Issue', 'dgenny' );
                default:
                    return '';
            }                 
