...
jQuery( document ).ready( function(){
    ...
    jQuery( '.dgenny-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
    ...
    jQuery( '.dgenny-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
    ...
    jQuery( document ).on( 'change', '.dgenny-field-post_type_taxonomy .dgenny-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.dgenny-field-post_type_taxonomy' );
    ...
    jQuery( '.dgenny-field-post_type_taxonomy .dgenny-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
    ...
    jQuery().registerAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.dgenny-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.dgenny-field-post_type_taxonomy .select_all_button_container, 
.dgenny-field-post_type_taxonomy .select_none_button_container
{
...
.dgenny-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'dgenny-loader' )
                    . "</label>"
                . "</div>";
